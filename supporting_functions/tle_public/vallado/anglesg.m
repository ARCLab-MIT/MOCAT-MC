...
%
% [r2,v2] = anglesg ( decl1,decl2,decl3,rtasc1,rtasc2,rtasc3,jd1,jd2,jd3,rs1,rs2,rs3 );
% ------------------------------------------------------------------------------  

function [r2, v2] = anglesg ( decl1,decl2,decl3,rtasc1,rtasc2, ...
                           rtasc3,jd1,jd2,jd3, rs1, rs2, rs3 );
...
l1
%   [l1eci,vs3,aeci] = ecef2eci(l1',vs,aecef,ttt,jdut1,0.0,0.0,0.0,0,ddpsi,ddeps);
%   [l2eci,vs3,aeci] = ecef2eci(l2',vs,aecef,ttt,jdut1,0.0,0.0,0.0,0,ddpsi,ddeps);
%   [l3eci,vs3,aeci] = ecef2eci(l3',vs,aecef,ttt,jdut1,0.0,0.0,0.0,0,ddpsi,ddeps);
...
fprintf(1,'a1/a3 %11.7f  %11.7f  %11.7f  %11.7f \n',a1,a1u,a3,a3u );
   ...
   decl1=  lir(2,1)*a1 - lir(2,2) + lir(2,3)*a3;
   decl2=  lir(2,1)*a1u + lir(2,3)*a3u;
decl1
decl2
...
fprintf(1,'magrs2 %11.7f  %11.7f  \n',magrs2,l2dotrs );
   ...
   poly( 2)=  0.0;
   poly( 3)=  -(decl1*decl1 + 2.0*decl1*l2dotrs + magrs2^2);
   poly( 4)=  0.0;
   poly( 5)=  0.0;
   poly( 6)=  -2.0*mu*(l2dotrs*decl2 + decl1*decl2);
   poly( 7)=  0.0;
   poly( 8)=  0.0;
   poly( 9)=  -mu*mu*decl2*decl2;
fprintf(1,'%11.7f \n',poly);
   rootarr = roots( poly );
rootarr
